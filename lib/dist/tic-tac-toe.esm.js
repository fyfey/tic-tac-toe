...
})(LobbyMessageType || (LobbyMessageType = {}));
var GameMessageType;
...
var MOVE = MessageType.MOVE;
var GAME_START = GameMessageType.GAME_START, GAME_QUIT = GameMessageType.GAME_QUIT, GAME_SEARCH = GameMessageType.GAME_SEARCH, GAME_PLAYER_ONE = GameMessageType.GAME_PLAYER_ONE, GAME_PLAYER_TWO = GameMessageType.GAME_PLAYER_TWO, GAME_WIN_ONE = GameMessageType.GAME_WIN_ONE, GAME_WIN_TWO = GameMessageType.GAME_WIN_TWO, GAME_STALE_MATE = GameMessageType.GAME_STALE_MATE;
...
export { Game, GameMessageType, LobbyMessageType, MessageType, Player, PlayerFactory, PlayerNumber, bitOffset, checkDraw, checkWin, decodeGamePacket, decodeMovePacket, encodeGamePacket, encodeMovePacket, getCell, getMask, gridToIndex, indexToGrid, indexToGridSize, setCell };
